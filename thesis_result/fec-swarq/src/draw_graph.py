...
def getLabel(data, each_val):
    if each_val is Xvalue.DUPLICATION:
        ...
        return "Rate{}".format(int(data.params["FEC_rate"] * 100))
...
def drawFECGraph(data_dict, all_file_list, is_ptime, is_coll):
    ...
    drawCompareGraph(data_dict, all_file_list, Xvalue.DISTANCE, Yvalue.FAILURE, Xvalue.RATE)
    ...
    drawCompareGraph(data_dict, all_file_list, Xvalue.DISTANCE, Yvalue.FAILURE, Xvalue.PACKETNUM)
    ...
    drawCompareGraph(data_dict, all_file_list, Xvalue.RATE, Yvalue.FAILURE, Xvalue.DISTANCE)
    ...
    drawCompareGraph(data_dict, all_file_list, Xvalue.RATE, Yvalue.FAILURE, Xvalue.PACKETNUM)
    ...
    drawCompareGraph(data_dict, all_file_list, Xvalue.PACKETNUM, Yvalue.FAILURE, Xvalue.RATE)
    ...
    drawCompareGraph(data_dict, all_file_list, Xvalue.PACKETNUM, Yvalue.FAILURE, Xvalue.DISTANCE)
